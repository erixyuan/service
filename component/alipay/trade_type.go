...
type Trade struct {
	...
	ProductCode string `json:"product_code,omitempty"` // 销售产品码，与支付宝签约的产品码名称。 参考官方文档, App 支付时默认值为 QUICK_MSECURITY_PAY
...
func (tpp TradePagePay) APIName() string {
	return "alipay.trade.page.pay"
}

func (tpp TradePagePay) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tpp.AppAuthToken
	m["notify_url"] = tpp.NotifyURL
	m["return_url"] = tpp.ReturnURL
	return m
}
...
func (tq TradeQuery) APIName() string {
	return "alipay.trade.query"
}

func (tq TradeQuery) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tq.AppAuthToken
	return m
}
...
func (tqr *TradeQueryRsp) IsSuccess() bool {
	if tqr.Content.Code == CodeSuccess {
		return true
	}
	return false
}
...
func (tc TradeClose) APIName() string {
	return "alipay.trade.close"
}

func (tc TradeClose) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tc.AppAuthToken
	m["notify_url"] = tc.NotifyURL
	return m
}
...
func (tr TradeRefund) APIName() string {
	return "alipay.trade.refund"
}

func (tr TradeRefund) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tr.AppAuthToken
	return m
}
...
func (trr *TradeRefundRsp) IsSuccess() bool {
	if trr.Content.Code == CodeSuccess {
		return true
	}
	return false
}
...
func (tfprq TradeFastPayRefundQuery) APIName() string {
	return "alipay.trade.fastpay.refund.query"
}

func (tfprq TradeFastPayRefundQuery) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tfprq.AppAuthToken
	return m
}
...
func (tfprqr *TradeFastPayRefundQueryRsp) IsSuccess() bool {
	if tfprqr.Content.Code == CodeSuccess {
		return true
	}
	return false
}
...
func (tqs TradeOrderSettle) APIName() string {
	return "alipay.trade.order.settle"
}

func (tqs TradeOrderSettle) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tqs.AppAuthToken
	return m
}
...
func (tc TradeCreate) APIName() string {
	return "alipay.trade.create"
}

func (tc TradeCreate) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tc.AppAuthToken
	m["notify_url"] = tc.NotifyURL
	return m
...
func (tp TradePay) APIName() string {
	return "alipay.trade.pay"
}

func (tp TradePay) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tp.AppAuthToken
	m["notify_url"] = tp.NotifyURL
	return m
}
...
func (tpr *TradePayRsp) IsSuccess() bool {
	if tpr.Content.Code == CodeSuccess {
		return true
	}
	return false
}
...
func (tap TradeAppPay) APIName() string {
	return "alipay.trade.app.pay"
}

func (tap TradeAppPay) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tap.AppAuthToken
	m["notify_url"] = tap.NotifyURL
	return m
}
...
func (tpc TradePreCreate) APIName() string {
	return "alipay.trade.precreate"
}

func (tpc TradePreCreate) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tpc.AppAuthToken
	m["notify_url"] = tpc.NotifyURL
	return m
}
...
func (tpcr *TradePreCreateRsp) IsSuccess() bool {
	if tpcr.Content.Code == CodeSuccess {
		return true
	}
	return false
}
...
func (tc TradeCancel) APIName() string {
	return "alipay.trade.cancel"
}

func (tc TradeCancel) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tc.AppAuthToken
	m["notify_url"] = tc.NotifyURL
	return m
...
func (tcr *TradeCancelRsp) IsSuccess() bool {
	if tcr.Content.Code == CodeSuccess {
		return true
	}
	return false
}
...
func (tois TradeOrderInfoSync) APIName() string {
	return "alipay.trade.orderinfo.sync"
}

func (tois TradeOrderInfoSync) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = tois.AppAuthToken
	return m
}
