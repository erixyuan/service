...
func (errRsp *ErrorRsp) Error() string {
	return fmt.Sprintf("%s - %s", errRsp.Code, errRsp.SubMsg)
}
...
func (cdl CertDownload) APIName() string {
	return "alipay.open.app.alipaycert.download"
}

func (cdl CertDownload) Params() map[string]string {
	var m = make(map[string]string)
	m["app_auth_token"] = cdl.AppAuthToken
	return m
}
